"""
ManterSessao Core - Módulo principal para prevenção de logout automático

Renomeado de NoLog/NoLogout -> ManterSessao para nomenclatura em português.
Esta classe provê a lógica de simulação de atividade do usuário para evitar
timeout e logout automático em estações Windows.
"""
import ctypes
import time
import json
...
class ManterSessaoCore:
    """Classe principal para gerenciar a prevenção de logout (ManterSessao)."""
